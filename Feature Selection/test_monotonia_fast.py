...
class FastMonotonicityTester:
    ...
    def _load_data(project_root: Path) -> tuple[np.ndarray, np.ndarray]:
        ...
        preprocessed_path = project_root / "DataPreprocessed" / "train_features_labels_preprocessed.csv"
...
def main():
    ...
    # Salva risultato
    report_path = project_root / "Feature Selection" / "outputs" / "monotonia_report_fast.txt"
